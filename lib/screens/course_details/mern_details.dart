...
class MernDetails extends StatefulWidget {
  ...
  @override
  State<MernDetails> createState() => _MernDetailsState();
}

class _MernDetailsState extends State<MernDetails> {
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: const Text(
                    'Master full-stack development with the MERN Stack  to build modern, scalable web applications.This course covers frontend and backend integration,equipping you with in-demand skills for the industry.',
                    style: TextStyle(
                      fontSize: 12,
                    ),
